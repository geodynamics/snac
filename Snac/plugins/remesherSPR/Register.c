...
const Name SnacRemesher_EP_RecoverNode =			"SnacRemesher_EP_RecoverNode";
...
void _SnacRemesher_Construct( void* component, Stg_ComponentFactory* cf, void* data ) {
	...
	Context_AddEntryPoint(
		context,
		SnacRemesher_EntryPoint_New( SnacRemesher_EP_RecoverNode, SnacRemesher_RecoverNode_CastType ) );
	Context_AddEntryPoint(
		context,
	...
	EntryPoint_Append(
		...
		SnacRemesher_Type );
	EntryPoint_Append(
		Context_GetEntryPoint( context, SnacRemesher_EP_RecoverNode ),
		SnacRemesher_Type,
		_SnacRemesher_RecoverNode,
		SnacRemesher_Type );
	EntryPoint_Append(
