...
#define __SnacRemesher_EntryPoint_h__
	...
	typedef void (SnacRemesher_RecoverNode_Cast)( void* context, unsigned nodeInd );
	...
	typedef void (SnacRemesher_RecoverNode_CallCast)( void* entryPoint, void* context, unsigned nodeInd );
	...
	#define SnacRemesher_RecoverNode_CastType			(Snac_CastType_MAX + 1)
	...
	#define SnacRemesher_CastType_MAX					(SnacRemesher_RecoverNode_CastType + 1)
	...
	/* Snac remesher entry point run... for recovering element varialbes as nodal fields. */
