...
#ifndef __SnacCylinderQuad_Register_h__
#define __SnacCylinderQuad_Register_h__

	/* Textual name of this class */
	extern const Type SnacCylinderQuad_Type;
...
#endif /* __SnacCylinderQuad_Register_h__ */
