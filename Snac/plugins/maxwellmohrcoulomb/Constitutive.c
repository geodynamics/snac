...
void SnacMaxwellMohrCoulomb_Constitutive( void* _context, Element_LocalIndex element_lI ) {
	Snac_Context* context = (Snac_Context*)_context;
	Snac_Element* element = Snac_Element_At( context, element_lI );
	SnacMaxwellMohrCoulomb_Element* viscoplasticElement = ExtensionManager_Get( context->mesh->elementExtensionMgr, element, SnacMaxwellMohrCoulomb_ElementHandle );
	...
	/* If this is a MaxwellMohrCoulomb material, calculate its stress. */
