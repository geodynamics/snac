...
void _SnacMaxwellMohrCoulomb_InterpolateElement( void* _context, 
					   ...
					   unsigned srcElementInd, unsigned srcTetInd )
{
	...
	Snac_Element*			element = (Snac_Element*)ExtensionManager_At( context->mesh->elementExtensionMgr, 
										      dstElements, 
										      dstElementInd );
	SnacMaxwellMohrCoulomb_Element*	elementExt = ExtensionManager_Get( context->mesh->elementExtensionMgr, 
									   element, 
									   SnacMaxwellMohrCoulomb_ElementHandle );
	Snac_Element*			fromElement;
	SnacMaxwellMohrCoulomb_Element*	fromElementExt;
