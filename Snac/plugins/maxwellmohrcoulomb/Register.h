...
#ifndef __SnacMaxwellMohrCoulomb_Register_h__
#define __SnacMaxwellMohrCoulomb_Register_h__
	
	/* Textual name of this class */
	extern const Type SnacMaxwellMohrCoulomb_Type;
	
	extern ExtensionInfo_Index SnacMaxwellMohrCoulomb_ElementHandle;
	
	extern ExtensionInfo_Index SnacMaxwellMohrCoulomb_ContextHandle;
...
#endif /* __SnacMaxwellMohrCoulomb_Register_h__ */
