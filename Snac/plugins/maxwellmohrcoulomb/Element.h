...
#ifndef __SnacMaxwellMohrCoulomb_Element_h__
#define __SnacMaxwellMohrCoulomb_Element_h__

	/* Element Information */
	struct _SnacMaxwellMohrCoulomb_Element {
	...
	void SnacMaxwellMohrCoulomb_Element_Print( void* element );

#endif /* __SnacMaxwellMohrCoulomb_Element_h__ */
