...
#ifndef __SnacPlasticMaxwell_Register_h__
#define __SnacPlasticMaxwell_Register_h__

	/* Textual name of this class */
	extern const Type SnacPlasticMaxwell_Type;

	/* Handles to extensions for quicker access */
	extern ExtensionInfo_Index SnacPlasticMaxwell_ContextHandle;
...
#endif /* __SnacPlasticMaxwell_Register_h__ */
