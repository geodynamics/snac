...
#ifndef __SnacMaxwell_Register_h__
#define __SnacMaxwell_Register_h__

	/* Textual name of this class */
	extern const Type SnacMaxwell_Type;

	/* Handles to extensions for quicker access */
	extern ExtensionInfo_Index SnacMaxwell_ElementHandle;

	extern ExtensionInfo_Index SnacMaxwell_ContextHandle;
...
#endif /* __SnacMaxwell_Register_h__ */
