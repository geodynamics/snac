...
void _SnacWinklerG3Force_Apply_North( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
void _SnacWinklerG3Force_Apply_South( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
void _SnacWinklerG3Force_Apply_East( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
void _SnacWinklerG3Force_Apply_West( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
void _SnacWinklerG3Force_Apply_Spherical_North( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
void _SnacWinklerG3Force_Apply_Spherical_South( void* _context, Node_LocalIndex	node_lI, Force* force, Force* balance );
double getRadius( Coord coord );

/*==========================================================================================*/
/*  Bottom support force ( a.k.a., Archimed's force, or WinklerG3 foundation ) term is added  */
/*==========================================================================================*/
...
/* 	_SnacWinklerG3Force_Apply_North( context, node_lI, force, balance ); */
/* 	_SnacWinklerG3Force_Apply_South( context, node_lI, force, balance ); */
/* 	_SnacWinklerG3Force_Apply_East( context, node_lI, force, balance ); */
/* 	_SnacWinklerG3Force_Apply_West( context, node_lI, force, balance ); */
}
		...
		Force*				balance )
{
	...
	_SnacWinklerG3Force_Apply_Spherical_North( context, node_lI, force, balance );
	_SnacWinklerG3Force_Apply_Spherical_South( context, node_lI, force, balance );
}
