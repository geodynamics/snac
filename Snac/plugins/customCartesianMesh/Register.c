...
const Type SnacCustomCartesian_Type = "SnacCustomCartesian";


Index _SnacCustomCartesian_Register( PluginsManager* pluginsMgr ) {
	return PluginsManager_Submit( pluginsMgr, 
				      SnacCustomCartesian_Type, 
				      "0", 
				      _SnacCustomCartesian_DefaultNew );
}


void* _SnacCustomCartesian_DefaultNew( Name name ) {
	return _Codelet_New( sizeof(Codelet), 
			     ...
			     _Codelet_Copy, 
			     _SnacCustomCartesian_DefaultNew, 
			     _SnacCustomCartesian_Construct, 
			     _Codelet_Build, 
			     _Codelet_Initialise, 
			     _Codelet_Execute, 
			     _Codelet_Destroy, 
...
void _SnacCustomCartesian_Construct( void* component, Stg_ComponentFactory* cf, void* data ) {
	...
	#ifdef DEBUG
		printf( "In: _SnacCustomCartesian_Register( void* )\n" );
	#endif
	...
	EntryPoint_InsertBefore(
		...
		"SnacIC",
		SnacCustomCartesian_Type,
		_SnacCustomCartesian_InitialConditions,
		SnacCustomCartesian_Type );
}
