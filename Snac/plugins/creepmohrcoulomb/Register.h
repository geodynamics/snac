...
#ifndef __SnacCreepMohrCoulomb_Register_h__
#define __SnacCreepMohrCoulomb_Register_h__
	
	/* Textual name of this class */
	extern const Type SnacCreepMohrCoulomb_Type;
	
	extern ExtensionInfo_Index SnacCreepMohrCoulomb_ElementHandle;
	
	extern ExtensionInfo_Index SnacCreepMohrCoulomb_ContextHandle;
...
#endif /* __SnacCreepMohrCoulomb_Register_h__ */
