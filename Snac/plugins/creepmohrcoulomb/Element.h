...
#ifndef __SnacCreepMohrCoulomb_Element_h__
#define __SnacCreepMohrCoulomb_Element_h__

	/* Element Information */
	struct _SnacCreepMohrCoulomb_Element {
	...
	void SnacCreepMohrCoulomb_Element_Print( void* element );

#endif /* __SnacCreepMohrCoulomb_Element_h__ */
