...
void _SnacCreepMohrCoulomb_ConstructExtensions( void* _context, void* data ) {
	Snac_Context*				context = (Snac_Context*)_context;
	SnacCreepMohrCoulomb_Context*			contextExt = ExtensionManager_Get(
							context->extensionMgr,
							context,
							SnacCreepMohrCoulomb_ContextHandle );
        Snac_Element                            tmpElement;
        SnacCreepMohrCoulomb_Element*               tmpElementExt = ExtensionManager_Get(
	...
	char					tmpBuf[PATH_MAX];
        ...
        Index                                   creepplasticOffsetCount = 1;
        SizeT                                   creepplasticOffsets[] = { 
                   (SizeT)((char*)&tmpElementExt->aps - (char*)&tmpElement) };
        Variable_DataType                       creepplasticDataTypes[] = { Variable_DataType_Double };
        Index                                   creepplasticDataTypeCounts[] = { 1 };
      ...
      //	#endif
        ...
        Variable_New(
                "plStrain",
                creepplasticOffsetCount,
                creepplasticOffsets,
                creepplasticDataTypes,
                creepplasticDataTypeCounts,
                0,
        ...
        for( element_lI = 0; element_lI < context->mesh->elementLocalCount; element_lI++ ) {
                        ...
                        SnacCreepMohrCoulomb_Element*       creepplasticElement = ExtensionManager_Get( context->mesh->elementExtensionMgr, element,
                                                                                                                SnacCreepMohrCoulomb_ElementHandle );
                        creepplasticElement->aps = 0.0f;
                }//for
