...
void _SnacCreepMohrCoulomb_InterpolateElement( void* _context, 
					   ...
					   unsigned srcElementInd, unsigned srcTetInd )
{
	...
	Snac_Element*			element = (Snac_Element*)ExtensionManager_At( context->mesh->elementExtensionMgr, 
										      dstElements, 
										      dstElementInd );
	SnacCreepMohrCoulomb_Element*	elementExt = ExtensionManager_Get( context->mesh->elementExtensionMgr, 
									   element, 
									   SnacCreepMohrCoulomb_ElementHandle );
	Snac_Element*			fromElement;
	SnacCreepMohrCoulomb_Element*	fromElementExt;
