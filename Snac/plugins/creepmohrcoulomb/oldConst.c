...
void SnacCreepMohrCoulomb_Constitutive( void* _context, Element_LocalIndex element_lI ) {
	...
	SnacCreepMohrCoulomb_Element* viscoplasticElement = ExtensionManager_Get( context->mesh->elementExtensionMgr, element, SnacCreepMohrCoulomb_ElementHandle );
	...
	if ( material->rheology & Snac_Material_CreepMohrCoulomb ) {
		...
		/*    printf("Entered CreepMohrCoulomb update \n"); */
