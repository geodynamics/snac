...
#ifndef __SnacPlSeeds_InitialConditions_h__
#define __SnacPlSeeds_InitialConditions_h__
	
	void _SnacPlSeeds_InitialConditions( void* _context, void* data );
	
#endif /* __SnacPlSeeds_InitialConditions_h__ */
