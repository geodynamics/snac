...
#ifndef __SnacPlSeeds_Register_h__
#define __SnacPlSeeds_Register_h__
	
	/* Textual name of this class */
	extern const Type SnacPlSeeds_Type;
	
	/* Structure extension handles */
	extern ExtensionInfo_Index SnacPlSeeds_MeshHandle;
...
#endif /* __SnacPlSeeds_Register_h__ */
