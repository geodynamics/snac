...
#ifndef __SnacSpherical_Register_h__
#define __SnacSpherical_Register_h__
	
	/* Textual name of this class */
	extern const Type SnacSpherical_Type;
	
	/* Structure extension handles */
	extern ExtensionInfo_Index SnacSpherical_MeshHandle;
...
#endif /* __SnacSpherical_Register_h__ */
