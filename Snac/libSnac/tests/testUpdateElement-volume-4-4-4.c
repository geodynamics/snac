...
**
** $Id: testUpdateElement-volume-4-4-4.c 3243 2006-10-12 09:04:00Z SteveQuenette $
**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
int main( int argc, char* argv[] ) {
	...
	printf( "Element: 0, volume: %g\n", Snac_Element_At( snacContext, elementIndex )->volume );
	...
	for( elementIndex = 1; elementIndex < snacContext->mesh->elementLocalCount; elementIndex++ ) {
		...
		error = False;		
		Snac_UpdateElementMomentum( (Context*)snacContext, elementIndex, &minLengthScale );
		if( Snac_Element_At( snacContext, elementIndex )->volume != Snac_Element_At( snacContext, 0 )->volume ) {
			printf( "Element: %u, volume: %g\n", elementIndex, Snac_Element_At( snacContext, elementIndex )->volume );
			error = True;
		}
