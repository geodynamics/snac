...
**
** $Id: testStrainRate-tetra-strainRate-4-4-4.c 3243 2006-10-12 09:04:00Z SteveQuenette $
**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
int main( int argc, char* argv[] ) {
	...
	/* Test1: Epsilon[0][0] of element 1 should be equal to 0.02 within tolerance^2 range.*/
	for( tetra_I = 0; tetra_I < Tetrahedra_Count; tetra_I++ ) {
		if( fabs( Snac_Element_At( snacContext, 1 )->tetra[tetra_I].strainRate[0][0] - 0.02 ) > TOL )
			printf( "Element 1, tetra %d: strainRate[0][0] computation failed: |%e - 0.02| > TOL (%e)\n",
					tetra_I,Snac_Element_At( snacContext, 1 )->tetra[tetra_I].strainRate[0][0], TOL );
	}
