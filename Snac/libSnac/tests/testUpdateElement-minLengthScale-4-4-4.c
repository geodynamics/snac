...
**
** Role:
**	Tests UpdateElementMomentum function for values of element's smallest length scale.
**
** $Id: testUpdateElement-minLengthScale-4-4-4.c 3243 2006-10-12 09:04:00Z SteveQuenette $
**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
int main( int argc, char* argv[] ) {
	...
	elementIndex = 0;
	Snac_UpdateElementMomentum( (Context*)snacContext, elementIndex, &minLengthScale0 );
	printf( "Element: 0, minLengthScale: %g\n", minLengthScale0 );
	...
	for( elementIndex = 1; elementIndex < snacContext->mesh->elementLocalCount; elementIndex++ ) {
		...
		for( tetraIndex = 0, error = False; tetraIndex < Tetrahedra_Count; tetraIndex++ ) {
			if( minLengthScale != minLengthScale0 ) {
				printf( "Element: %u, minLengthScale: %g\n", elementIndex, minLengthScale );
				error = True;
			}
		}
