...
**
** $Id: testStress-stress-4-4-4.c 3229 2006-06-19 01:09:20Z EunseoChoi $
**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
int main( int argc, char* argv[] ) {
	...
	printf( "Element: 0, stress: %g\n", Snac_Element_At( snacContext, 0 )->stress );
	...
	for( elementIndex = 1; elementIndex < snacContext->mesh->elementLocalCount; elementIndex++ ) {
		...
		Snac_StrainRate( (Context*)snacContext, elementIndex );
		SnacTest_Stress( (Context*)snacContext, elementIndex );
		if( Snac_Element_At( snacContext, elementIndex )->stress != Snac_Element_At( snacContext, 0 )->stress ) {
			printf( "Element: %u, Stress: %g\n", elementIndex, Snac_Element_At( snacContext, elementIndex )->stress );
			error = True;
		}
